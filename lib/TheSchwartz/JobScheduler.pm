...
=head1 SYNOPSIS
    ...
    # $ENV{THESCHWARTZ_JOBSCHEDULER_DBHANDLEPROVIDER}
    #         = 'TheSchwartz::JobScheduler::DBHandleProvider';
    # my @databases = (
    #     {
    #         dsn => 'dbi:Pg:dbname=scheduler_db;host=localhost;port=5432',
    #         username => '',
    #         password => '',
    #         dbi_params => {},
    #         connection_args => {
    #             ReadOnly => 0, AutoCommit => 0,
    #             PrintError => 0, RaiseError => 1,
    #             printWarn => 0, RaiseWarn => 1,
...
Internally, TheSchwartz::JobScheduler is using L<Database::ManagedHandle>
to maintain the open database handles. This package makes it possible
to have long running connections even to cloud services which
could close at any moment for a sudden update.
If the connection breaks, L<Database::ManagedHandle> will
establish it again automatically.
